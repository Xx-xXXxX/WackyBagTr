...
{
	public interface INPCBehavior:IBehavior {
		/// <summary>
	...
	public abstract class NPCBehavior<TModeNPC>(TModeNPC modNPC) :Behavior, INPCBehavior
		where TModeNPC:ModNPC
	{
		public TModeNPC ModNPC { get; } = modNPC;
	...
	public interface INPCBehaviorMarked : IBehavior
	{
		/// <summary>
		/// Allows you to set all your NPC's properties, such as width, damage, aiStyle, lifeMax, etc.
		/// </summary>
